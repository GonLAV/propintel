...
export function AdvancedMarketComparison({ property, onSelectComparables }) {
  const [searchRadius, setSearchRadius] = useState([1.5])
  const [maxResults, setMaxResults] = useState(10)
  const [propertyTypes, _setPropertyTypes] = useState([property.type])
